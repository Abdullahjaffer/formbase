		...
		<div className="min-h-screen bg-white text-gray-900 font-sans selection:bg-indigo-100 selection:text-indigo-700">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="flex justify-between items-center h-16">
						...
						<div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-600">
							...
							<Link
								href="/admin"
								className="bg-gray-900 text-white px-5 py-2 rounded-full hover:bg-gray-800 transition-all flex items-center gap-2 shadow-sm"
							>
								Dashboard
			...
			<section className="pt-32 pb-20 px-4">
				<div className="max-w-5xl mx-auto text-center">
					<div className="inline-flex items-center gap-2 bg-indigo-50 text-indigo-700 px-4 py-2 rounded-full text-sm font-bold mb-8 animate-fade-in border border-indigo-100">
					...
					<div className="flex flex-col sm:flex-row items-center justify-center gap-4">
						...
						<a
							...
							className="w-full sm:w-auto bg-white border border-gray-200 text-gray-700 px-8 py-4 rounded-2xl text-lg font-bold hover:bg-gray-50 transition-all flex items-center justify-center gap-2"
						>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						{[
							...
							>
								<div className="bg-gray-50 w-12 h-12 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
									{feature.icon}
								</div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="flex flex-col lg:flex-row items-center gap-16">
						...
						<div className="flex-1 w-full">
							<div className="bg-gray-900 rounded-3xl p-1 shadow-2xl overflow-hidden">
  ...
  body: JSON.stringify({
    ...
    plan: 'Premium'
			...
			<section className="py-24 px-4">
				<div className="max-w-4xl mx-auto bg-indigo-600 rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl shadow-indigo-200 text-white">
